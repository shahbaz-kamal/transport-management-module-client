      ...
      <div className=" grid min-h-screen  grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative hidden lg:block">
          ...
          <div className="absolute bottom-10 left-8 right-8 text-white">
            <h2 className="text-3xl font-bold leading-tight">Manage routes, vehicles, and transport fees</h2>
            <p className="mt-3 text-sm opacity-90">
              Create routes, add pickup points, and assign students—fees generate automatically for the month.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-1 items-center justify-center px-4 pb-10 lg:px-10">
            <div className="w-full max-w-md">
              <h1 className="mb-2 text-2xl font-semibold">Register to continue</h1>
